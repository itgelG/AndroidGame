...
//    public final static float MAZE_UNIT_HEIGHT = 10.0f;
    ...
    // map unit
    private static class MazeMapUnit {
    ...
    public MazeMap(SceneManager sm, int mapIndex) {
        mazeMap = new Vector<>();
        sceneManager = sm;
        this.mapIndex = mapIndex;
    }

    public void readMazeMap(Context context, int resourceId) {
        ...
        for (MazeMapUnit unit : mazeMap) {
            Cube tempCube = new Cube(sceneManager.getContext(), mapIndex);
